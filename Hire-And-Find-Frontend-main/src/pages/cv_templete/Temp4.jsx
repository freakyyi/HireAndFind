            ...
            <header>
              <div className="row row1">
                ...
                <div className="c2">
                  ...
                  <br />
                  <p className="p1">{this.props.phone}</p>
                  <p className="p1">{this.props.email}</p>
                </div>
              </div>
            </header>
            <section id="details4">
              <div className="aboutme">
                ...
                <div className="c2">
                  <p className="p1">{this.props.summary}</p>
                </div>
              </div>
              <div className="aboutme">
                <div className="c1">
                ...
                <div className="c2">
                  <p className="p1 mt-2">{skills}</p>
                </div>
              </div>
              <div className="aboutme">
                <div className="c1">
                  <h6 className="title">Work</h6>
                </div>
                <div className="c2">
