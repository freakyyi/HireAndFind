...
class DownloadCV extends Component {
  ...
  getCV = async () => {
    console.log(this.props.match.params.seekerid);
    try {
      console.log("in full gham");
      let results = await requests.getCV(this.props.match.params.seekerid);
      results = results[0];
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="inner-header">
                  <h3>
                    {this.state.firstname} {this.state.lastname} Resume{" "}
                  </h3>
                </div>
              </div>
            </div>
...
export default withRouter(DownloadCV);
